...
RefineImageInteractor::RefineImageInteractor() {}

RefineImageInteractor::~RefineImageInteractor() {}

void RefineImageInteractor::ConnectActionsAndFunctions()
{
...
void RefineImageInteractor::DataNodeChanged()
{
...
// read.
void RefineImageInteractor::Paint(mitk::StateMachineAction *, mitk::InteractionEvent *event)
{
  try
  {
